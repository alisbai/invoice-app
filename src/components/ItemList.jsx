...
export default function ItemList({ form }) {
            ...
            <div>
              <span
                className={`item-attribute 
                                ${
                                  lightSwitch
                                    ? "item-attribute-bright-mode"
                                    : "item-attribute-dark-mode"
                                }`}
              >
                Item Name
              </span>
            ...
            <div>
              ...
              <span
                className={`item-total-price ${
                  lightSwitch
                    ? "item-total-price-bright-mode"
                    : "item-total-price-dark-mode"
                }`}
              >
  ...
  return (
    <div
      className={`heading-font-s1 item-list ${
        lightSwitch ? "item-list-bright-mode" : "item-list-dark-mode"
      }`}
    >
      <h3
        className={`item-list-header ${
          lightSwitch
            ? "item-list-header-bright-mode"
            : "item-list-header-dark-mode"
        }`}
      >
        Item List
      </h3>
