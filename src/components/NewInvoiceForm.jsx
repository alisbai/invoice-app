...
export default function NewInvoiceFrom({formActionButtonsWrapperClassName}) {
    ...
    const {register,setValue, handleSubmit, formState: {errors}, control, reset} = form;
    ...
    const onSubmit = (data) => {
        ...
        const month = currentDate.getMonth();
        const day = currentDate.getDate();
        data.createdAt = `${year}-${padStart(month + 1, 2, "0")}-${padStart(day, 2, "0")}`;
        data.id = generateId();
        data.total = data.items.reduce((accumulator, item) => accumulator + item.total, 0)
    ...
    const generateForm = () => {
        ...
        if(screenDimensions.width > 675) {
            return (<form className={`new-invoice-form`}>
                        <h2 
                        ...
                        <fieldset>
                            ...
                            />
                            <TextField {...register("senderAddress.street", {
                            ...
                            <div className="new-invoice-form-3-fields-wrapper">
                                <div>
                                    ...
                                    />
                                    <TextField {...register("senderAddress.city" , {
                                        required: true
                                    })} 
                                    error={!!errors?.senderAddress?.city}
                                    />
                                ...
                                <div>
                                    ...
                                    />
                                    <TextField {...register("senderAddress.postCode", {
                                        required: true,
                                        pattern: /^\d+$/
                                    })}
                                    error={!!errors?.senderAddress?.postCode}
                                ...
                                <div>
                                    ...
                                    />
                                    <TextField {...register("senderAddress.country", {
                                        required: true
                                    })} 
                                    error={!!errors?.senderAddress?.country}
                                    />
                        ...
                        <fieldset>
                            <span className="heading-font-s1 new-invoice-form-section-title">Bill To</span>
                                ...
                                />
                                <TextField type="email" {...register("clientEmail", {
                                    required: messageForRequiredInput
                                })}
                                error={!!errors?.clientEmail}
                                />
                                ...
                                />
                                <TextField {...register("clientAddress.street", {
                                    required: messageForRequiredInput
                                })} 
                                error={!!errors?.clientAddress?.street}
                                />
                            ...
                            <div className="new-invoice-form-3-fields-wrapper">
                                <div>
                                    ...
                                    />
                                    <TextField {...register("clientAddress.city", {
                                        required: true
                                    })} 
                                    error={!!errors?.clientAddress?.city}
                                    />
                                ...
                                <div>
                                    ...
                                    />
                                    <TextField {...register("clientAddress.postCode", {
                                        pattern: /^\d+$/,
                                        required: true
                                    })} 
                                    error={!!errors?.clientAddress?.postCode}
                                ...
                                <div>
                                    ...
                                    />
                                    <TextField {...register("clientAddress.country", {
                                        required: true
                                    })} 
                                    error={!!errors?.clientAddress?.country}
                                    />
        ...
        <>
            ...
            <div className="form-action-buttons-z-index-container">
                ...
                >
                    ...
                    <PrimaryButton 
                    onClick={saveAsPaid} 
                    className="save-and-send-button" 
                    text="Save & Send" />
                </div>
            </div>
        </>
