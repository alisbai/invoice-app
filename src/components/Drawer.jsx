...
export default function Drawer() {
        ...
        const  [formActionButtonsWrapperClassName, setFormActionButtonsWrapperClassName] = useState("form-action-buttons-wrapper-box-shadow");
      ...
      if (scrollPosition === maxScroll) {
        ...
        setFormActionButtonsWrapperClassName("form-action-buttons-wrapper-box-shadow");
      }
        }    
    return(
        <div 
        ...
        >
            <NewInvoiceFrom formActionButtonsWrapperClassName={formActionButtonsWrapperClassName} />
        </div>
    )
}